		...
		<div class="main-content">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container" style="width:540px;height:450px">
						<div class="center">
							<h2>
								<i class="ace-icon fa fa-leaf green"></i> <span class="white"
									id="id-text2"><%=AppVar.systemName%></span>
							</h2>
							<div class="space-6"></div>
							<h4 class="blue" id="id-company-text">
								&copy;<%=AppVar.companyName%></h4>
						</div>
                        <div class="space-6"></div>
						<div class="space-6"></div>
						<div class="space-6"></div>
						<div class="position-relative" style="margin:0 auto;width:400px;" >
...
<!-- 												<label class="block clearfix"> <span -->
<!-- 														class="block input-icon input-icon-right"> <input -->
<!-- 															name="textVerifyCode" id="textVerifyCode" type="text" -->
<!-- 															class="form-control" placeholder="验证码" /> -->
<!-- 															<i class="ace-icon fa glyphicon-eye-open"></i> -->
<!-- 													</span> -->
<!-- 											    </label> -->
				...
				function(e) {
					...
					$.ajax({
						...
						success : function(data) {
							if (data == null || data == "") {
							    var url = "<%=request.getContextPath()%>/main?random=" + Math.random();
